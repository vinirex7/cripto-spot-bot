...
class PositionStore:
    ...
    def get(self, symbol: str) -> Dict[str, Any]:
        return self._data.get(symbol, {"in_position": False, "entry_price": 0.0, "peak_price": 0.0, "entry_ts": ""})
    ...
    def on_buy_filled(self, symbol: str, fill_price: float) -> None:
        ...
        pos["entry_ts"] = datetime.now(timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
        self.set(symbol, pos)
    ...
    def on_sell_filled(self, symbol: str) -> None:
        self.set(symbol, {"in_position": False, "entry_price": 0.0, "peak_price": 0.0, "entry_ts": ""})
